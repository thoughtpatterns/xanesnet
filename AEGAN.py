...
class AEGANTrainer(nn.Module):
    def __init__(self, **params):
        ...
        self.gen_a = AEGen(input_size = self.input_size_a, num_hidden_layer = self.n_hl_gen, hidden_size = self.hidden_size, dropout = self.dropout, activation = self.activation) # autoencoder for domain a
        self.gen_b = AEGen(input_size = self.input_size_b, num_hidden_layer = self.n_hl_gen, hidden_size = self.hidden_size, dropout = self.dropout, activation = self.activation) # autoencoder for domain b
...
def train_aegan (x, y, hyperparams, n_epoch):
    ...
    model = AEGANTrainer(dim_a = hyperparams['input_size_a'],
